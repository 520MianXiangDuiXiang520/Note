...
* [多进程](#多进程)
  * [1.进程的创建与管理](#1.进程的创建与管理)
    * [1.1-Process类](#1.1-Process类)
      * [1.1.1-Process类的属性和方法](#1.1.1-Process类的属性和方法)
      * [1.1.2-创建子进程的两种方法](#1.1.2-创建子进程的两种方法)
        * [(1.)使用函数创建](#(1.)使用函数创建)
        * [(2.)使用类创建](#(2.)使用类创建)
      * [1.1.3-僵尸进程和孤儿进程](#1.1.3-僵尸进程和孤儿进程)
        * [(1.)僵尸进程](#(1.)僵尸进程)
        * [(2.)孤儿进程](#(2.)孤儿进程)
    * [1.2-进程并行](#1.2-进程并行)
    * [1.3-守护进程](#1.3-守护进程)
