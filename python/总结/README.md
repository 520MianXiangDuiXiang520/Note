...
* [python-重要知识点总结](#python-重要知识点总结)
  * [DAY-1.-函数的参数传递](#DAY-1.-函数的参数传递)
    * [1.1-总结](#1.1-总结)
  * [DAY-2.-元类](#DAY-2.-元类)
    * [2.1-元类是什么](#2.1-元类是什么)
    * [2.2-创建类的另一种方法](#2.2-创建类的另一种方法)
      * [通过type创建类](#通过type创建类)
    * [2.3-MetaClass](#2.3-MetaClass)
    * [2.4-总结](#2.4-总结)
  * [DAY-3.-静态方法和类方法](#DAY-3.-静态方法和类方法)
    * [3.1-总结](#3.1-总结)
  * [DAY-4.-类变量（属性）和实例变量（属性）](#DAY-4.-类变量（属性）和实例变量（属性）)
    * [4.1-总结](#4.1-总结)
  * [DAY-5.-python自省](#DAY-5.-python自省)
    * [5.1-python实现自省的办法](#5.1-python实现自省的办法)
      * [5.1.1-help()](#5.1.1-help())
      * [5.1.2-dir()](#5.1.2-dir())
      * [5.1.3-hasattr()，getattr(),setattr()](#5.1.3-hasattr()，getattr(),setattr())
      * [5.1.4-isinstance()，issubclass()](#5.1.4-isinstance()，issubclass())
      * [5.1.5-id()和callable()](#5.1.5-id()和callable())
      * [5.1.6-type()](#5.1.6-type())
    * [5.2-总结](#5.2-总结)
  * [DAY-6.-生成式,迭代器，生成器](#DAY-6.-生成式,迭代器，生成器)
    * [6.1-生成式](#6.1-生成式)
      * [6.1.1-列表生成式](#6.1.1-列表生成式)
      * [6.1.2-字典生成式](#6.1.2-字典生成式)
      * [6.1.3-集合生成式](#6.1.3-集合生成式)
    * [6.2-生成器](#6.2-生成器)
    * [6.3-迭代器](#6.3-迭代器)
      * [6.3.1-可迭代对象](#6.3.1-可迭代对象)
      * [6.3.2-迭代器](#6.3.2-迭代器)
    * [6.4-总结](#6.4-总结)
  * [DAY-7.-格式化字符串](#DAY-7.-格式化字符串)
    * [7.1-%格式化字符串](#7.1-%格式化字符串)
    * [7.2-format()](#7.2-format())
    * [7.3-f-string](#7.3-f-string)
      * [7.3.2-格式规范迷你语言](#7.3.2-格式规范迷你语言)
        * [(1)-对齐-align](#(1)-对齐-align)
        * [(2)-sign](#(2)-sign)
        * [(3)-#选项](#(3)-#选项)
        * [(4)-,选项](#(4)-,选项)
        * [(5)-width](#(5)-width)
        ...
        * [(7)-type](#(7)-type)
    * [7.4-总结](#7.4-总结)
  * [DAY-8.-*args和**kwargs](#DAY-8.-*args和**kwargs)
  * [DAY-9.-闭包和装饰器](#DAY-9.-闭包和装饰器)
    * [9.1-闭包](#9.1-闭包)
      * [闭包的作用](#闭包的作用)
    * [9.2-装饰器](#9.2-装饰器)
      * [9.2.1-装饰器带参数](#9.2.1-装饰器带参数)
      * [9.2.2-被修饰函数带参数](#9.2.2-被修饰函数带参数)
      * [9.2.3-例](#9.2.3-例)
    * [9.3-总结](#9.3-总结)
  * [DAY-10.-鸭子类型](#DAY-10.-鸭子类型)
  * [前十天总结](#前十天总结)
  * [DAY-11.-python-重载](#DAY-11.-python-重载)
    * [11.2-单分派泛型函数](#11.2-单分派泛型函数)
    * [11.3-总结](#11.3-总结)
  * [DAY-12.-python新式类和旧式类](#DAY-12.-python新式类和旧式类)
    * [12.1-新式类和旧式类的区别](#12.1-新式类和旧式类的区别)
    * [12.2-总结](#12.2-总结)
  * [DAY-13.-单例设计](#DAY-13.-单例设计)
    * [13.1-什么是单例设计](#13.1-什么是单例设计)
    * [13.2-实现单例设计的方法](#13.2-实现单例设计的方法)
      * [13.2.1-重写__new__()](#13.2.1-重写__new__())
      * [13.2.2-使用装饰器](#13.2.2-使用装饰器)
      * [13.2.3-使用模块](#13.2.3-使用模块)
      * [13.2.4-共享属性](#13.2.4-共享属性)
    * [13.3-总结](#13.3-总结)
  * [DAY-14.-python多线程](#DAY-14.-python多线程)
    * [14.1-计算机多任务的实现](#14.1-计算机多任务的实现)
    * [14.2-python多线程](#14.2-python多线程)
      * [14.2.1-线程间共享全局变量](#14.2.1-线程间共享全局变量)
      * [14.2.2-多线程实现UDP通信](#14.2.2-多线程实现UDP通信)
      * [14.2.3-守护线程](#14.2.3-守护线程)
      * [14.2.4-练习](#14.2.4-练习)
    * [14.3-总结](#14.3-总结)
  * [DAY-15.-python多进程](#DAY-15.-python多进程)
    * [15.1-进程与程序](#15.1-进程与程序)
    * [15.2-python进程的创建](#15.2-python进程的创建)
    * [15.3-僵尸进程和孤儿进程](#15.3-僵尸进程和孤儿进程)
    * [15.4-进程并行Pool](#15.4-进程并行Pool)
    * [15.5-守护进程](#15.5-守护进程)
    * [15.5-进程同步Lock](#15.5-进程同步Lock)
    * [15.6-进程间通信](#15.6-进程间通信)
    * [15.7-总结](#15.7-总结)
  * [DAY-16.-python协程](#DAY-16.-python协程)
    * [16.1-复习-可迭代对象，迭代器，生成器](#16.1-复习-可迭代对象，迭代器，生成器)
    * [16.2-yield实现协程](#16.2-yield实现协程)
    * [16.3-greenlet实现协程](#16.3-greenlet实现协程)
    * [16.4-gevent实现协程](#16.4-gevent实现协程)
    * [16.5-总结](#16.5-总结)
  * [DAY-17.-GIL](#DAY-17.-GIL)
    * [17.1-什么是GIL，GIL产生的原因](#17.1-什么是GIL，GIL产生的原因)
    * [17.2-GIL对python线程的影响](#17.2-GIL对python线程的影响)
    * [17.3-解决GIL的办法](#17.3-解决GIL的办法)
  * [python多任务总结](#python多任务总结)
  * [DAY-18.-python垃圾回收机制](#DAY-18.-python垃圾回收机制)
    * [18.1-引用计数（Reference-Counting）](#18.1-引用计数（Reference-Counting）)
    * [18.2-标记清除（Mark-Sweep）](#18.2-标记清除（Mark-Sweep）)
    * [18.3-分代回收](#18.3-分代回收)
    * [18.4-总结](#18.4-总结)
  * [DAY-19.-lambda表达式](#DAY-19.-lambda表达式)
  * [总结（二）](#总结（二）)
  * [DAY-20.-python拷贝](#DAY-20.-python拷贝)
  * [DAY-21.-python设计模式](#DAY-21.-python设计模式)
